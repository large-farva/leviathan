...
ID_LIKE="fedora"
VERSION_ID=42
VERSION_CODENAME="Bad Boy"
PRETTY_NAME="Leviathan-DX 1.0 (FROM Fedora Silverblue)"
...
VARIANT="Silverblue"
VARIANT_ID=leviathan-dx-gnome-nvidia
OSTREE_VERSION='42.20250621.0'
BUILD_ID="Latest (F42.20250621)"
BOOTLOADER_NAME="Leviathan-DX (F42.20250621)"
IMAGE_ID="leviathan-dx-gnome-nvidia-42.20250621"
EOF

cat > /etc/machine-info <<'EOF'
PRETTY_HOSTNAME=Leviathan-DX
ICON_NAME=
EOF
